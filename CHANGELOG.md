...
- Cennik kosztu dania ma teraz też siedem warzyw, których ZSRIR notuje wyłącznie hurtowo — kapustę, buraki, por, seler, pietruszkę, sałatę i ogórek. Cena to średnia hurtowa z 5 rynków razy jawnie nazwany przelicznik ×1,6 (decyzja właściciela, D-286), a zdanie na stronie przepisu mówi to wprost: „(…; część cen to szacunek z cen hurtowych MRiRW/ZSRIR)”. Warzywa detaliczne (ziemniaki, cebula, marchew, papryka czerwona, pomidor) odświeżają się teraz **automatycznie, co tydzień**, przez nowy workflow GitHub Actions (`ceny-warzyw-auto.yml`), który otwiera zwykły PR do przeglądu — nic nie trafia do `main` bez scalenia przez człowieka, a produkcja nadal niczego nie pobiera z sieci (D-286).
