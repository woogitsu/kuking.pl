...
- Panel „Wiadomości do nas”: poprawienie notatki w załatwionej wiadomości nie zmienia już daty ani osoby, która ją załatwiła, i nie przesuwa terminu jej usunięcia. Nowa data i nowa osoba pojawiają się dopiero przy prawdziwym ponownym zamknięciu (#843).
