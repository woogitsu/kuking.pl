...
- „Zrób swoją wersję” pod cudzym publicznym przepisem: jednym przyciskiem dostajecie kopię tego przepisu do zmiany, widoczną tylko dla Was — składniki i kroki, bez cudzych zdjęć. Nad tytułem wersji zawsze stoi podpis „Na podstawie przepisu: „…” · autor”, którego nie da się usunąć. Wersji bez żadnej zmiany w składnikach, krokach, czasie albo porcjach nie da się opublikować („To jest ten sam przepis. Może wystarczy »Ugotowałem«?”). Autor oryginału dostaje powiadomienie, gdy wersja zostanie opublikowana tak, że może ją zobaczyć, a pod jego przepisem pojawia się lista „Wersje innych osób” — bez liczników. Usunięcie oryginału nie usuwa wersji: podpis zostaje z dopiskiem, że oryginał jest niedostępny. Wersja bardzo podobna do oryginału nie trafia do wyszukiwarek, a żadna wersja nie trafia do mapy strony. Paczka z danymi mówi przy przepisie, od kiedy jest Waszą wersją i czego (#23, D-301).
