...
- Formularz „Prywatność” otwarty w starej karcie nie zapisuje już ponownie na tygodniowy e-mail kogoś, kto w międzyczasie wypisał się odnośnikiem z listu, ani nie włącza z powrotem wspomnień wyłączonych w innej karcie. Zapis zmienia tylko to, co człowiek przestawił na tym ekranie, a komunikat mówi, które ustawienie zostało zmienione gdzie indziej i jak świadomie wrócić do listu.
