...
- Pod stopką nie ma już wysokiego pustego pasa. Miejsce na dolną belkę nawigacji jest zostawiane raz i tylko wtedy, gdy belka naprawdę jest na ekranie — osoba niezalogowana, która belki nie ma, nie przewija już kilkuset pikseli pustki.
