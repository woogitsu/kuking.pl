...
- Po usunięciu konta zdarzenia z analizy działania serwisu przestają być z nim powiązane i znikają same po 90 dniach, jak wszystkie inne. Polityka prywatności mówi to wprost i ma nową datę stanu — 25 września 2026. Zgody udzielone wcześniej zostają ważne i dalej wskazują brzmienie, na które je dano (#1324).
