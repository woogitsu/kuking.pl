...
- Kto wybrał formę na pytanie „Jak mamy do Ciebie pisać?”, widzi ją w pierwszych miejscach serwisu: na końcu zakładania konta i w pustym „Świeżo z Kuking” („co dziś ugotowałaś” albo „ugotowałeś”), na przycisku kończącym tryb gotowania (przy formie żeńskiej „Ugotowałam”), w stopce tygodniowego podsumowania i listu z paczką danych. Autor przepisu na ekranie „Komuś wyszło” czyta o kucharzu w formie, którą kucharz sam wybrał („Halina ugotowała Twój przepis”). Kto nic nie wybrał, dostaje teksty bez rodzaju — także tam, gdzie po zalogowaniu stało dotąd „ugotowałeś” („co dziś gotujesz”). Pozostałe ekrany (strona główna, powiadomienia, przycisk pod przepisem, formularz wykonania) przejdą w kolejnym etapie (#1753).
...
- Link do logowania, który przeleżał w kolejce dłużej, niż jest ważny, albo został zastąpiony nowszym, nie jest już wysyłany. List mówi, jak długo link jeszcze działa, licząc od chwili zamówienia.
