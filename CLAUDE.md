...
Sprawdź `docs/ROADMAP.md` i `docs/FEATURES.md` (sekcja „V2”) — od D-282
(26 września 2026, patrz `AGENTS.md`) V2 wolno budować; lista „Nie wcześnie”
w tym samym pliku pozostaje zakazana bez zmian.
