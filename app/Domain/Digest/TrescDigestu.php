 ...
 *
 * @phpstan-type Zapis array{odbiorca: User, wykonania: list<CookedEvent>, nowiObserwujacy: list<User>, ileNowychObserwujacych: int, wpisyObserwowanych: list<Post>, pytanieGospodarza: ?string}
 */
