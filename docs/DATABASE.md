...
`2026_09_20_120000_usun_zamrozone_wycinki_komentarzy` — **migracja danych, nie
...
**to nie jest przywrócenie**. Jedynym źródłem tych wartości po uruchomieniu
jest kopia zapasowa bazy sprzed migracji.
