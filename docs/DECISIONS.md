...
| D-014 | Nie budujemy API „pod przyszłą aplikację mobilną" | zmienione decyzją właściciela 25.09.2026 — API budowane (zasady: D-270) | [D-014-nie-budujemy-api-pod-przyszla-aplikacje.md](decyzje/D-014-nie-budujemy-api-pod-przyszla-aplikacje.md) |
...
| D-070 | Zapisy przepisu przez różne osoby łączą się w jedno powiadomienie, dopóki autor go nie przeczyta (#906, PR #1213, 23 września 2026) | — | [D-070-zapisy-przepisu-przez-rozne-osoby-lacza.md](decyzje/D-070-zapisy-przepisu-przez-rozne-osoby-lacza.md) |
...
| D-194 | „Ugotowałem" jest ważniejsze niż lajk | obowiązuje (sprostowany przez D-275, 25 września 2026) | [D-194-ugotowalem-jest-wazniejsze-niz-lajk.md](decyzje/D-194-ugotowalem-jest-wazniejsze-niz-lajk.md) |
...
| D-250 | Klucz API wychodzi tylko pod dokładny adres dostawcy: host, port i ścieżka z kodu (#991, 23 września 2026) | obowiązuje | [D-250-klucz-api-wychodzi-tylko-pod-dokladny.md](decyzje/D-250-klucz-api-wychodzi-tylko-pod-dokladny.md) |
...
| D-258 | Poprawiony wpis przechodzi analizę automatu jeszcze raz; wpisu pod decyzją moderacji nie da się edytować (24 września 2026) | obowiązuje | [D-258-poprawiony-wpis-przechodzi-analize-automatu.md](decyzje/D-258-poprawiony-wpis-przechodzi-analize-automatu.md) |
| D-259 | Własne „Ugotowałem” otwiera się kucharzowi mimo blokady z autorem przepisu; przepis zostaje zamknięty (#1394, PR #1503, 24 września 2026) | obowiązuje | [D-259-wlasne-ugotowalem-otwiera-sie-kucharzowi-mimo.md](decyzje/D-259-wlasne-ugotowalem-otwiera-sie-kucharzowi-mimo.md) |
| D-261 | Wykonanie zbanowanego kucharza znika także pod bezpośrednim adresem (25 września 2026) | obowiązuje | [D-261-wykonanie-zbanowanego-kucharza-znika-takze-pod.md](decyzje/D-261-wykonanie-zbanowanego-kucharza-znika-takze-pod.md) |
| D-262 | Panel moderacji: napisy pomocnicze poniżej 18 px, świadomy wyjątek od AGENTS.md §5 (audyt B1, znalezisko 7, 25 września 2026) | obowiązuje | [D-262-panel-moderacji-napisy-pomocnicze-ponizej-18.md](decyzje/D-262-panel-moderacji-napisy-pomocnicze-ponizej-18.md) |
| D-263 | Zawieszone konto może zablokować natręta i zgłosić treść (audyt B2-03, 25 września 2026) | obowiązuje | [D-263-zawieszone-konto-moze-zablokowac-natreta-i.md](decyzje/D-263-zawieszone-konto-moze-zablokowac-natreta-i.md) |
...
| D-269 | Urodziny (dzień i miesiąc), życzenia, mail za osobną zgodą, przypomnienie obserwującym, rocznica dołączenia (#1754, #1755, 25 września 2026) | obowiązuje | [D-269-urodziny-zyczenia-mail-za-osobna-zgoda.md](decyzje/D-269-urodziny-zyczenia-mail-za-osobna-zgoda.md) |
| D-270 | Publiczne API `/api/v1`: tokeny Sanctum, domyślnie zamknięte, jeden format błędu (25 września 2026) | obowiązuje | [D-270-publiczne-api-api-v1-tokeny-sanctum.md](decyzje/D-270-publiczne-api-api-v1-tokeny-sanctum.md) |
| D-274 | „Jeden wpis na autora” (#940) jest nadrzędny wobec wpisu z własną treścią (#1377) (25 września 2026) | obowiązuje | [D-274-jeden-wpis-na-autora-jest-nadrzedny.md](decyzje/D-274-jeden-wpis-na-autora-jest-nadrzedny.md) |
| D-275 | Reguła doboru treści: zamknięta lista dozwolonych reguł (#1806, #1781, sprostowanie D-194, 25 września 2026) | obowiązuje | [D-275-regula-doboru-tresci-zamknieta-lista-dozwolonych.md](decyzje/D-275-regula-doboru-tresci-zamknieta-lista-dozwolonych.md) |
| D-276 | „Świeżo z Kuking”: rotacja autorów zamiast jednego wpisu od osoby (#1807, #1781, zmienia #940, 25 września 2026) | obowiązuje | [D-276-swiezo-z-kuking-rotacja-autorow-zamiast.md](decyzje/D-276-swiezo-z-kuking-rotacja-autorow-zamiast.md) |
| D-277 | Start: obserwowane tagi razem z obserwowanymi osobami (#1808, #1781, zmienia D-021, 25 września 2026) | obowiązuje | [D-277-start-obserwowane-tagi-razem-z-obserwowanymi.md](decyzje/D-277-start-obserwowane-tagi-razem-z-obserwowanymi.md) |
| D-281 | „Komentarze (N)” pod zwykłym wpisem liczy odpowiedzi; pytanie nie (#1801, 26 września 2026) | obowiązuje | [D-281-komentarze-pod-zwyklym-wpisem-liczy-odpowiedzi.md](decyzje/D-281-komentarze-pod-zwyklym-wpisem-liczy-odpowiedzi.md) |
| D-282 | V2 z `docs/FEATURES.md` wolno budować od 26 września 2026 (Nie wcześnie — bez zmian) | obowiązuje | [D-282-v2-z-docs-features-md-wolno.md](decyzje/D-282-v2-z-docs-features-md-wolno.md) |
| D-284 | Skalowanie porcji i zamienniki składników od autora, bez AI (V2, 26 września 2026) | obowiązuje | [D-284-skalowanie-porcji-i-zamienniki-skladnikow-od.md](decyzje/D-284-skalowanie-porcji-i-zamienniki-skladnikow-od.md) |
