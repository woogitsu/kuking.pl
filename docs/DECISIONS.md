...
|---|---|---|
| domyślnie | `8rem` = 128 px | „tekst 140%", belka 105,5 px (zapas 22,5 px) |
| `max-width: 15rem` | `13rem` = 416 px | czcionka przeglądarki 200%, belka 376,2 px (zapas 39,8 px) |
...
zawsze: belka dalej `fixed` (nie `sticky`), token wydany w obu miejscach, stopnie
nie ścięte.
