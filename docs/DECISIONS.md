...
z 26 września 2026 dopuszczająca funkcje z listy V2 (`docs/FEATURES.md`,
„V2”: *pantry* i *„co ugotuję z tego, co mam”*) · Gałąź `claude/v2-pantry`
...
konfiguracją, nie kodem — np. `config('kuking.pantry.dopasowanie_ai')` z
`KUKING_PANTRY_AI_MODEL` (domyślnie puste = wyłączone) i kluczem dostawcy
w sekretach środowiska. Granice propozycji: model dostaje wyłącznie parę
