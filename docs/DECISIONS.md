...
miejscu, bez migracji i bez utraty powiązań. Na produkcji cisza jest
zakazana: funkcja włączona bez kluczy daje `/health` → `degraded` z powodem
`google_bez_kluczy`, tak samo jak Turnstile bez kluczy — bo inaczej mielibyśmy
drogę wejścia, która melduje sukces, nie istniejąc.
...
`app/Domain/Users/Actions/EraseAccountData.php` ·
`app/Http/Controllers/HealthController.php` ·
`database/migrations/2026_09_10_500000_add_google_account_to_users.php` ·
