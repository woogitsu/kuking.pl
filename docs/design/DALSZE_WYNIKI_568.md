...
## Integracja skali — 16 września

Lokalny merge cd06224 łączy korektę wyszukiwania z pakietem #589 (16aa4c1). Rozwiązano wyłącznie konflikty changeloga i numeru wersji: zachowano opisy 0.41 oraz 0.42, bieżąca etykieta to Alfa 0.42. Build Vite i 22 testy wyszukiwania / 124 asercje przeszły. Ponowiono 36 konfiguracji rzeczywistej strony z wynikiem 201 (320, 360, 390, 414, 768, 1440 px; oba motywy; 70%, 100%, 140%): bez poziomego overflow, obliczone fonty zgodne ze skalą. Obejrzano zrzuty 320 px ciemny/70% oraz jasny/140%. Podpowiedź wyglądu zamknięto rzeczywistym przyciskiem Rozumiem przed ponownym oglądem karty. To nie jest powtórzenie całej macierzy działań ani prawdziwego zoomu; wcześniejsze dowody pozostają osobno. Nowy hook i CI integracji są nadal wymagane.
