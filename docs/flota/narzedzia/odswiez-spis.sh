#!/usr/bin/env bash
# WYMAGA: układu katalogów kuking-flota/ obok Codex/kuking.pl na dysku tej maszyny oraz 'gh'; poza tą maszyną nie zadziała — czyta się go jak zapis tego, co spis mierzył.
