...
ST = "/tmp/claude-0/-workspace-kuking-pl/59748e86-571c-55a6-9b6e-f2c80a66befa/scratchpad/czuwanie/stan.json"
...
ls = subprocess.run(["git", "-C", "/workspace/kuking.pl", "ls-remote", "--heads", "origin"], capture_output=True, text=True).stdout
heads = {}
