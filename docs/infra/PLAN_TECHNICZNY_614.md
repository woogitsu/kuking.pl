...
|---|---|---|---|
| Volume #596 | CLOSED | [pomiar cudzy: opis #596, zakończenie 17.09] volume odłączono, nie usunięto; zachowano kopię. Zalecenie wykonane, nie wraca na listę implementacji. | Zachować zasady retencji kopii; nie kasować volume „porządkując” audyt. |
...
| Kolejka #606 | CLOSED | Zalecenie o `SKIP LOCKED` zweryfikowane w ramach #606; audyt nie zleca kolejnej implementacji już dostępnego mechanizmu. | Zachować kontrolę zachowania przy rzeczywistych workerach. |
