...
| **Ponowna analiza po EDYCJI treści** | **WPISY: WDROŻONE (D-258). Komentarze: ODŁOŻONE, ze świadomą luką** | Poprawiony wpis (tekst, tytuł pytania, tagi) i wpis wychodzący z „tylko ja” przechodzą analizę jeszcze raz (D-258, #936); jedno oznaczenie na treść zostaje, więc odrzucone nadal nie wraca. Wpisu ukrytego lub usuniętego przez moderację nie da się edytować. Dla komentarzy: opublikować niewinny wpis i dopisać spam edycją to najprostsze obejście tego wykrywacza. Nie zamykamy go dziś, bo jedno oznaczenie na treść jest fundamentem obietnicy „odrzucone nie wraca", a ponowna analiza po każdej poprawce literówki kosztuje zadanie w kolejce za każdym razem. Ta luka jest zamykana zgłoszeniem od człowieka i **musi wrócić na stół**, gdy pojawi się pierwszy przypadek. |
