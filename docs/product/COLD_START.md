...
- **rotacja autorów**: najpierw najnowszy wpis każdej osoby, potem drugi każdej i tak dalej; własne wpisy widza stoją w tej samej rotacji, nie są odsiewane ani wyróżniane (inaczej 3 aktywne osoby zasłonią wszystko; #1807, D-276 — wcześniej jeden wpis od osoby w całej liście, #940);
