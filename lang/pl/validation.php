...
return [
    ...
    'boolean' => 'Zaznacz przy „:attribute” jedną z dwóch odpowiedzi: tak albo nie.',
    ...
    'filled' => 'Uzupełnij pole „:attribute” — zostało puste.',
    'gt' => [
    ...
    'integer' => 'Wpisz w polu „:attribute” samą liczbę całkowitą, bez przecinka i bez kropki.',
    ...
    'max' => [
        ...
        'numeric' => 'Ta liczba jest za duża w polu „:attribute”. Wpisz :max albo mniej.',
        'string' => 'Pole „:attribute” jest za długie. Skróć je do :max :odmiana(znaku|znaków|znaków).',
    ],
    ...
    'min' => [
        ...
        'numeric' => 'Ta liczba jest za mała w polu „:attribute”. Wpisz :min albo więcej.',
        'string' => 'Pole „:attribute” jest za krótkie. Dopisz tak, żeby miało co najmniej :min :odmiana(znak|znaki|znaków).',
    ],
    ...
    'numeric' => 'Wpisz w polu „:attribute” samą liczbę, bez innych znaków.',
    'password' => [
    ...
    'regex' => 'Nie umiemy odczytać tego, co jest w polu „:attribute”. Sprawdź wpisaną wartość i popraw ją.',
    'required' => 'Uzupełnij pole „:attribute” i wyślij formularz jeszcze raz.',
    ...
    */
    ...
    'attributes' => [
        'name' => 'nazwa zeszytu',
        'description' => 'opis',
        // Nazwa musi być tym, CO CZŁOWIEK WIDZI. Na żadnym ekranie nie ma
        // napisu „widoczność", jest pytanie „Kto ma to widzieć?".
        'visibility' => 'odpowiedź, kto ma to widzieć',
        ...
        // BEZ CUDZYSŁOWU W ŚRODKU: szablony walidacji same otaczają nazwę
        // pola cudzysłowem drukarskim, więc nazwa z własnym cudzysłowem dawała
        // na ekranie „Pole «odpowiedź «zrobię jeszcze raz»» przyjmuje...".
        'would_make_again' => 'odpowiedź, czy zrobisz to jeszcze raz',
        'perceived_difficulty' => 'trudność przepisu',
        'actual_minutes' => 'czas, który Ci to zajęło',
        'body' => 'treść',
