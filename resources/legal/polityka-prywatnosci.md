...
| Bezpieczeństwo (dziennik ważnych zdarzeń, próby logowania) | **skrót** adresu IP (samego adresu w bazie nie ma; skrót liczymy z użyciem klucza, który żyje poza bazą, więc kto dostanie sam zrzut tabeli, adresu z niego nie wyczyta — ale to nie to samo co „nie da się go odtworzyć nigdy i nikomu"), znacznik czasu, typ zdarzenia | Nasz uzasadniony interes w ochronie serwisu przed nadużyciami | **12 miesięcy** — i to jest okres, który serwis naprawdę pilnuje: co noc usuwa wpisy starsze niż 12 miesięcy. Wyjątek: wpisy, które dokumentują, że złożyłeś albo cofnąłeś żądanie usunięcia konta, albo że je wykonaliśmy, zostają na stałe — to jest nasz dowód, że to naprawdę zrobiliśmy |
| Powiadomienia w serwisie | treść powiadomienia, informacja czy przeczytane | Wykonanie umowy | **3 miesiące** od otrzymania, niezależnie od tego, czy je przeczytałeś — i to jest okres, który serwis naprawdę pilnuje: co noc usuwa powiadomienia starsze niż 3 miesiące. Wyjątek: powiadomienia o decyzji moderacyjnej i o wyniku odwołania zostają dłużej, do upływu terminu na odwołanie — **co najmniej 6 miesięcy** od decyzji (Regulamin, §8) |
...
| Sprawdzenie, czy ludzie wracają do Kuking (statystyki produktowe) | znacznik czasu Twojej ostatniej wizyty w serwisie — bez adresu IP, bez listy stron, które odwiedziłeś | Nasz uzasadniony interes w sprawdzeniu, czy serwis realnie służy ludziom, którzy się zarejestrowali | Nie jest to log zdarzeń — to jedna, bieżąca wartość na konto, nadpisywana przy każdej kolejnej wizycie (nie częściej niż raz na kilkanaście minut). Poprzednia wartość nigdzie nie zostaje. Znika wraz z usunięciem lub anonimizacją konta |
