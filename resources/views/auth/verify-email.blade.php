...
<x-layout title="Potwierdź adres e-mail" :noindex="true">
    ...
    @if ($nieudanaWysylka !== null)
        <p class="notice">
            ...
            Wysłaliśmy ją {{ \App\Support\Czas::data($nieudanaWysylka->failed_at, 'j.m.Y') }}
            o {{ \App\Support\Czas::data($nieudanaWysylka->failed_at, 'H:i') }}, ale nasz dostawca poczty jej nie przyjął —
