...
--}}
@props(['event', 'showRecipe' => false, 'przepisDostepny' => null, 'przepisZaBlokada' => false])
<article class="card" data-klucz="wykonanie-{{ $event->getKey() }}">
    ...
    @if($showRecipe)
        <p class="m-0 mb-3">
            ...
            @elseif($event->recipe && ($przepisDostepny ?? \Illuminate\Support\Facades\Gate::allows('view', $event->recipe)))
