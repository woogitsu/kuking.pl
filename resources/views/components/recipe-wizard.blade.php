...
new class extends Component
{
    ...
    /**
     * Liczba porcji do podglądu — liczona TYM SAMYM kodem, co znaczek
     * na stronie przepisu (`Recipe::servingsLabel()`), a nie drugą kopią
     * odmiany liczebnika obok. Model nie jest zapisywany.
     *
     * PO CO TO POWSTAŁO (issue #38)
     * Podgląd pisał `(int) previewServings().' porcji'`, czyli dokładnie
     * to, co `servingsLabel()` naprawiało na stronie przepisu (audyt A28):
     *
     *     w polu 1     → „1 porcji"     (nie po polsku)
     *     w polu 2     → „2 porcji"     (nie po polsku)
     *     w polu 0,5   → „0 porcji"     (nieprawda o samym sobie)
     *
