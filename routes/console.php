...
//
// Także jedna replika może nałożyć stary i nowy kontener podczas wdrożenia.
// KAŻDE zadanie ma `->onOneServer()` — nie z powodu
// tej pary, tylko dlatego, że każdy kontener ma własny harmonogram (#595).
