...
if (PHP_SAPI !== 'cli' || ! $app->environment(['local', 'testing'])
    ...
    || (! $ci && ($port !== '55439' || ! in_array($database, ['kuking_581_browser', 'kuking_581_acceptance', 'kuking_581_menu', 'kuking_581_menu_extra', 'kuking_581_details', 'kuking_581_validation'], true)))
