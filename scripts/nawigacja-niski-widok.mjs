        ...
        if (negatywy) {
            ...
            const mutations = [
                [
                    ...
                    (text) =>
                        text.replace(
                            "[data-marka] .bottom-nav { position: relative; inset: auto; margin: calc(8px * var(--user-layout-scale, 1)); margin-bottom: calc(calc(8px * var(--user-layout-scale, 1)) + var(--safe-bottom)); }",
