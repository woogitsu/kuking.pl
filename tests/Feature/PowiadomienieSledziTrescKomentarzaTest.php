...
class PowiadomienieSledziTrescKomentarzaTest extends TestCase
{
    ...
    /**
     * To samo na całym ekranie — i tu asercja jest NA LICZBĘ, wbrew zwyczajowi
     * tego repozytorium, bo mierzy coś, czego ta zmiana NIE naprawia.
     *
     * Zmierzone na `36b9bddd` (baza tej gałęzi, PRZED tą zmianą): 16 zapytań
     * przy 2 powiadomieniach o komentarzu i 66 przy 12 — czyli PIĘĆ zapytań
     * na wiersz. To nie jest koszt wycinka: to `Notification::adresDocelowy()`
     * → `urlDoKomentarza()`, wołane z widoku dla każdego wiersza od issue
     * #759 (`adeff046`), żeby policzyć stronę i kotwicę wątku. Osobna oś,
     * osobne issue, świadomie NIE ruszana tutaj.
     *
     * Ta asercja pilnuje więc jednej rzeczy: że żywy wycinek nie dokłada
     * do tych pięciu ŻADNEGO szóstego zapytania na wiersz. Gdyby ktoś
     * naprawił kiedyś oś #759, ten test oblejnie z liczbą mniejszą — i to
     * jest dobra porażka, bo każe zaktualizować zmierzoną liczbę, a nie
     * zgadywać ją.
     */
    public function test_zywy_wycinek_nie_doklada_zapytania_na_wiersz_listy(): void
    {
        ...
        $this->assertSame(
            ...
            "Koszt wiersza listy powiadomień zmienił się: {$malo} zapytań przy 2 wierszach, {$duzo} przy 12. "
                .'Pięć zapytań na wiersz to zmierzona oś #759 (adres „Zobacz"); wycinek treści ma nie dokładać nic.',
        );
    }
