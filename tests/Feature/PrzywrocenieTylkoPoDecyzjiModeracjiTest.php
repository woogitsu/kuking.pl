...
class PrzywrocenieTylkoPoDecyzjiModeracjiTest extends TestCase
{
    ...
    public function test_moderator_nie_widzi_przycisku_przy_decyzji_administratora(): void
    {
        ...
        $this->actingAs($this->moderator())
            ...
            ->assertSee('Przywrócić tę treść może tylko administrator — przekaż mu sprawę.', false);
        ...
        $this->actingAs($admin)
            ...
            ->assertDontSee('Przywrócić tę treść może tylko administrator — przekaż mu sprawę.', false);
    }
