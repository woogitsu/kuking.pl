...
class RozdrozeUstawienTest extends TestCase
{
    ...
    /**
     * Wszystkie ekrany ustawień — jedenaście (urodziny doszły przy #1755, ukryte przy #1810). Ta sama lista co
    ...
    public function test_rozdroze_wymienia_widocznym_napisem_wszystkie_dziesiec_ekranow(): void
    {
        ...
        // KONTROLA DODATNIA LICZBY: spis ma jedenaście pozycji i ani jednej
        ...
        $this->assertCount(
            ...
            'Rozdroże wymienia inną liczbę ekranów niż jedenaście — albo doszedł nowy '.
